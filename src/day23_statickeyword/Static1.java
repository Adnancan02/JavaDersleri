...
public class Static1 {
	...
	static String isim = "Mehmet"; // isim burda Static bu okul adý 
	int yas = 49;                   // yas burda instance 

	public static void main(String[] args) {
		// static variable lar olusturulan tum objeler için gecerlidir(okul adý gýbý)
