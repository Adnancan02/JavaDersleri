...
public class C2_PassByValue02 {
	...
	public static double indirimUygula25(double fiyat) {// 2. declaration

		fiyat*=0.75;

		//double fiyat;
		return fiyat; // 1. declaration
	}

	public static double indirimUygula20(double fiyat) { // 3. declaration
	...
	public static double indirimUygula10(double fiyat) {// 4. declaration
