...
public class C7_IfElseIf2 {
	...
	public static void main(String[] args) {
		...
		*/
		...
		if(sayi1==0 && sayi2==0) {
			System.out.println("Sýfýrdan carpmaya göre yutan elemanýdýr");
			
		}else if(sayi1>0 && sayi2>0){
			System.out.println("sayýlarýn toplamýný= " +(sayi1+sayi2));
			...
			System.out.println("farklý isaretlerde sayýlarla iþlem yapýlmaz");
		}
