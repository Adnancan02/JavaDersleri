...
public class C2_MethodCreation2 {
    ...
    //  Kullanici toplamak istedigi sayi adedini 4’den buyuk girerse “Cok sayi girdiniz, 
      //    ben toplayamam” yazdirin.
		...
		System.out.println("Lutfen kac sayi toplamak istediðini giriniz");
	...
	if (adet<2) {
       ...
       public static void dortSayiTopla() {
		...
		System.out.println("dort sayýnýn toplamaý =" +(sayi1+sayi2+sayi3+sayi4));
	}
	...
	public static void ucSayiTopla() {
		 Scanner scan= new Scanner(System.in);
			...
			System.out.println("Uc sayýnýn toplamaý =" +(sayi1+sayi2+sayi3));
	}
	...
	public static void ikiSayiTopla() {
		 Scanner scan= new Scanner(System.in);
			...
			System.out.println("iki sayýnýn toplamaý =" +(sayi1+sayi2));
