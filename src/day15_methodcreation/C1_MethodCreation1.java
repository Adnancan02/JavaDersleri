...
public class C1_MethodCreation1 {
	...
	public static void main(String[] args) {
	 ...
	 üc basamklý veya  buyukse birler,onlar ve yuzler basamagindaki rakamlarin toplamini,
	 100’den kucukse sadece 1’ler basamagini yazdirin.
	*/
		Scanner scan = new Scanner(System.in);
		System.out.println("Lutfen bir tam sayi giriniz");
		int sayi = scan.nextInt();
		pozitifNegatif(sayi);// girilen sayi argumentinin pozitif yada negatif oldugunun yazdýrsýn
	    tekMiCiftMi(sayi);
	    if (sayi>=100) {
			yuzdenBuyuk(sayi);
